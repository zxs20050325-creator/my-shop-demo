// server.js - 冀遗筑梦特别版 (已配置图片路径 + 6图分页)
...
const MOCK_PRODUCTS = [
    ...
    { 
        id: 1, 
        name: "【镇店之宝】冀州古韵·微缩避暑山庄", 
        price: 399, 
        desc: "皇家园林典范，缩尺还原山水之间，承载千年古建智慧。", 
        img: "images/001.jpg" 
    },
    { 
        id: 2, 
    ...
    { 
        ...
        name: "【古城印记】正定记忆·浮雕砖刻", 
        price: 268, 
        desc: "复刻古城墙纹理，抚摸历史的痕迹，自在正定，文化传承。", 
        img: "images/006.jpg" 
    },
...
app.get('/api/products', (req, res) => {
    ...
    // 【重要修改】将 limit 从 4 改为 6，确保第一页刚好展示 001-006
    const limit = 6; 
    res.json({
